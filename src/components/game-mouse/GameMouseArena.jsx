...
export default function GameMouseArena() {
  const [activeGame, setActiveGame] = useState('balon-terbang'); // 'balon-terbang' | 'harta-karun'
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b-2 border-black/20 pb-3">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-xl font-heading font-black text-xs sm:text-sm uppercase border-3 border-black transition-all flex items-center gap-2 cursor-pointer ${
            ...
            >
              <span>💎</span>
              <span>Game 2: Detektif Harta Karun</span>
              <span className="hidden sm:inline text-[10px] font-mono font-bold bg-white/80 px-1.5 py-0.5 rounded border border-black/30">
                Double Click
              </span>
            </button>
