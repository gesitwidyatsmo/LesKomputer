...
const MOUSE_GAMES = [
  ...
  {
    id: 'pabrik-burger',
    title: 'Pabrik Burger & Sortir Sampah',
    focus: 'Seret & Lepas (Drag-and-Drop)',
    desc: 'Susun lapisan burger lezat ke atas piring saji atau pilah sampah daur ulang ke tong yang tepat dengan menahan klik kiri.',
    icon: '🍔',
    duration: '4-5 Menit',
    status: 'upcoming',
