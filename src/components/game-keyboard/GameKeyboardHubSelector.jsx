...
export const KEYBOARD_GAMES = [
  ...
  },
  {
    ...
    status: 'ready',
    color: 'bg-rose-200',
    tagColor: 'bg-rose-300 text-black',
    tagText: 'SIAP DIMAINKAN',
    waves: '5 Babak Kata',
  },
  {
    ...
    desc: 'Latih tombol Caps Lock: nyalakan Caps Lock untuk mengetik huruf BESAR bersama Monster Marah (Mode Berteriak), dan matikan Caps Lock untuk mengetik huruf kecil bersama Peri Tidur (Mode Berbisik).',
    icon: '📢',
    duration: '4-5 Menit',
    status: 'ready',
    color: 'bg-purple-200',
  ...
  },
  {
    ...
    desc: 'Nyalakan lampu sorot mercusuar untuk mengungkap simbol misterius (!, @, #, $, %, ?, *) dan menemukan benda tersembunyi di kegelapan dengan menahan tombol Shift.',
    icon: '🔦',
    duration: '4-5 Menit',
    status: 'ready',
    color: 'bg-cyan-200',
