...
export default function HeroSection({ data, globalWhatsapp }) {
  ...
  const waLink = formatWhatsAppUrl(globalWhatsapp, ctaWhatsappMessage);
  ...
  return (
    <section id="beranda" className="relative pt-10 pb-20 lg:pt-16 lg:pb-28 bg-[#FFFDF5] bg-retro-dots overflow-hidden border-b-3 border-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`grid grid-cols-1 ${showSimulator ? "lg:grid-cols-12 gap-12 lg:gap-8" : "max-w-3xl mx-auto"} items-center`}>
          
          {/* Left Column: Hero Content */}
          <div className={`${showSimulator ? "lg:col-span-7" : "w-full"} max-w-2xl`}>
            ...
            {/* CTA Action Buttons */}
            {(showCtaWhatsapp || showCtaSecondary) && (
          ...
          {showSimulator && (
            ...
            {showFloatingBadges && floatingBadgeLeftTitle && (
            ...
            {showFloatingBadges && floatingBadgeRightText && (
