...
export const metadata = {
	...
	title: 'GWA Tech Course - Kursus Komputer dari Nol Sampai Mahir',
...
export default function RootLayout({ children }) {
	return (
		<html
			...
			<body className='min-h-full flex flex-col font-sans text-slate-950 bg-[#FFFDF5] selection:bg-amber-300 selection:text-black'>{children}</body>
		</html>
	);
}
