      ...
      <div className="md:hidden p-4 bg-amber-100 border-2 border-black rounded-xl shadow-[3px_3px_0px_0px_#000] flex items-start gap-3">
        ...
        <div className="text-xs space-y-1">
          ...
          <p className="text-slate-700 leading-relaxed font-medium">
            Latihan mengetik 10 jari dirancang optimal menggunakan <strong>Keyboard Fisik PC / Laptop</strong>. Di HP, kamu tetap dapat mempelajari posisi jari dan panduan teknik mengetik pada kartu panduan di bawah!
          </p>
        </div>
      </div>
